...
var SEQ = (function () {
     ...
     */
    function stop() {
        throw new Error('Maximum iterations reached or insufficient points provided! No solutions found.');
    }
     ...
     * @returns {Sequence}
     */
    function Sequence(sequence, variable = 'x') {
        //set the sequence
    ...
    Sequence.equals = function (a, b) {
        if (a.length !== b.length) {
            return false;
        }

        // Loop through both arrays and compare elements. If any one element doesn't match we return false
    ...
    /**
     * Calculates the polynomial given a sequence
     * @returns {Sequence}
     */
    Sequence.prototype.analyze = function () {
        ...
        for (var i = 0; i < 50; i++) {
            ...
            if (Sequence.equals(this.sequence, deltas)) {
                stop();
            }
    ...
    /**
     * Calculates the sequence based on its terms
     * @param {type} n
     * @returns {Sequence}
     */
